...
func Migrator() {
	...
	initialData := []interface{}{
		...
		&models.Video{
			...
			ProjectsID:   1,
			SeriesNumber: 4,
			SeriesURL:    "https://storage.yandexcloud.net/zetrego/anime/hazbinhotel/s1e5/S0E0_Hazbin4.m3u8",
		},
		&models.Video{
			SeasonID:     4,
			ProjectsID:   2,
		...
		&models.Video{
			...
			ProjectsID:   2,
			SeriesNumber: 6,
			SeriesURL:    "https://storage.yandexcloud.net/zetrego/anime/demonslayer/4/%D1%816/demonslayer46.m3u8",
		},
		...
		&models.Video{
			...
			ProjectsID:   4,
			SeriesNumber: 3,
			SeriesURL:    "https://storage.yandexcloud.net/zetrego/anime/windbreaker/1/s3/wb13_1.m3u8",
		},
